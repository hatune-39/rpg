advancement grant @s only rpg:skill/skillset/enderset1
#advancement grant @s only rpg:skill/skillset/enderset
advancement grant @s only rpg:skill/skillset/page1/set
...
tag @s remove skillset2
tag @s remove skillset3
tag @s remove skillset4
