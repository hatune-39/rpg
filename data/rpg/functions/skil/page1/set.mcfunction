...
clear @s #rpg:skill{category:2}

execute if entity @s[tag=doubleattack] run item replace entity @s enderchest.0 with shears{display:{Name:'{"text": "ダブルアタック"}'},skill:1,page:1}
advancement revoke @s only rpg:skill/skillset/page1/set