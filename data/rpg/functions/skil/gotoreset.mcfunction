item replace entity @s[tag=!skillsetng] enderchest.0 with paper{display:{Name:'{"text": "スキルを設定しました！"}'},category:100}
item replace entity @s[tag=skillsetng] enderchest.0 with paper{display:{Name:'{"text": "すでにこのスキルが設定されていたため、変更されませんでした！"}'},category:100}
...
advancement revoke @s only rpg:skill/skillset/endreset
tag @s remove skillsetng